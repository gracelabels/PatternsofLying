...
Our first research question was relatively simple. While it is an impossible question to answer definitively, we decided to look at each rating tier and see the breakdown by party to get a sense of which party receives more false ratings.
...
Below are the counts of claims by party and textual Rating
