...
Having cleaning, sorted, and tagged all of our data, we embarked on our mission to understand political lying! This document contains our initial data analysis that we used to answer some of our research questions. Exploration of where politicians lie is featured in the Location of Lie Analysis.Rmd. 
...
The third most populous category in 2020 was Voting/Elections falsehoods. Falsehoods about stolen elections. voter fraud, and mail-in voting dominated the 2020 political news resulting in this spike. 
Looking farther back, we see lots of Government Operations checks - many of which concern government spending. These fact-checks decline in 2019 and 2020, perhaps as fact-checkers focused energy on more urgent topics like COVID.
