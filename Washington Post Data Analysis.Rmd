...
v8_wapo$textualRating[v8_wapo$...1 == "14285"] <- "Three Pinocchios"
v8_wapo$textualRating[v8_wapo$...1 == "13484"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "14105"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13781"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13878"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14630"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "3214"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13957"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14480"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14481"] <- "Three Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14201"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "14662"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "13696"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "13887"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14339"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "13448"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14693"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13940"] <- "One Pinocchio"
v8_wapo$textualRating[v8_wapo$...1 == "14131"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "14534"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "13540"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14116"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "13628"] <- "Three Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13894"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13420"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13403"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13370"] <- "Two Pinocchios"
v8_wapo$textualRating[v8_wapo$...1 == "13371"] <- "One Pinocchio"
v8_wapo$textualRating[v8_wapo$...1 == "13987"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13952"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "14441"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13410"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13367"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13369"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14403"] <- "One Pinocchio" 
v8_wapo$textualRating[v8_wapo$...1 == "14576"] <- "Four Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13445"] <- "Three Pinocchios"
v8_wapo$textualRating[v8_wapo$...1 == "13399"] <- "Four Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "13873"] <- "Four Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14009"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14628"] <- "Three Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14588"] <- "Three Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14540"] <- "Three Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14023"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14337"] <- "Two Pinocchios" 
v8_wapo$textualRating[v8_wapo$...1 == "14488"] <- "Three Pinocchios"
v8_wapo$textualRating[v8_wapo$...1 == "13453"] <- "Three Pinocchios"
...
v8_wapo_cleantextRating$textualRating <- 
  factor(v8_wapo_cleantextRating$textualRating, 
...
```{r, warning=FALSE, message=FALSE, echo = FALSE}
ggplot(v8_wapo_cleantextRating, aes(x = claimant_party, fill = textualRating)) +
         geom_bar(position = "fill") +
