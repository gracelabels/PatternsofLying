...
In V4, before we split the data by publisher, Trump's statements accounted for 2984 of 7337 in the data.
Responsible for 40% of all claims fact-checked, he was overrepresented in the data.
As he contributed to the party counts, his large number of Republican falsehoods threatened to skew party analyses.
