...
We made the decision to remove Donald Trump entirely from this dataset. To do so, we first identified all the different iterations of "Trump" within the `claimant` column. We could not simply remove all claimants whose names included Trump, because by our definitions, his daughter Ivanka Trump was a politician.
