...
```{r manual removal for v4, message=FALSE, warning=FALSE}
...
```{r tables for v4, message=FALSE, warning=FALSE}
v4_dejunked %>%
  count() %>%
...
```{r create v5, message=FALSE, warning=FALSE}
v5_pf <- v4_dejunked %>%
...
```{r find trump names, message=FALSE, warning=FALSE}
...
```{r create v6, message=FALSE, warning=FALSE}
