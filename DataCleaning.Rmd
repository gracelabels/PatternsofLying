...
Given these categories are too small to draw statistically relevant conclusions from the data, and so as to not distract from the findings about two major US parties, claims with an Independent or Libertarian party affiliation were removed. Only Democratic and Republican claims remain in the datasets.
